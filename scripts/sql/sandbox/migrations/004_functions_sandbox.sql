...
-- Source:  004_functions.sql
-- Branch:  sandbox/second-customer-skeleton
-- Project: fullsite-sandbox (NEVER apply to qjiomlvudfmzuvqvhwpk)
--
-- Transformations applied:
--   [1] OMITTED: cancel_stale_pending_reservations (amalay_reservaciones)
--   [2] OMITTED: gen_codigo_reserva (trigger for amalay_reservaciones)
--   [3] OMITTED: r1_observation_sample (hardcoded client_id=amalay)
--   [4] SECURITY DEFINER functions: SET search_path = 'public' added where missing
--   [5] SECURITY DEFINER functions: REVOKE FROM PUBLIC + GRANT TO authenticated/service_role
-- =============================================================================
...
-- OMITTED IN SANDBOX: cancel_stale_pending_reservations
...
-- OMITTED IN SANDBOX: gen_codigo_reserva
...
REVOKE EXECUTE ON FUNCTION public.r1_adjust_market_stock(text, text, text, numeric, text, text) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_adjust_market_stock(text, text, text, numeric, text, text) TO authenticated, service_role;
...
REVOKE EXECUTE ON FUNCTION public.r1_legacy_sale_deduction(text, text, text, jsonb) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_legacy_sale_deduction(text, text, text, jsonb) TO authenticated, service_role;
...
REVOKE EXECUTE ON FUNCTION public.r1_merge_orders(text, text, bigint, text, bigint, jsonb, numeric, numeric, numeric, integer, text) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_merge_orders(text, text, bigint, text, bigint, jsonb, numeric, numeric, numeric, integer, text) TO authenticated, service_role;

-- OMITTED IN SANDBOX: r1_observation_sample
...
REVOKE EXECUTE ON FUNCTION public.r1_reconcile_item(text, text, text, text, numeric, text) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_reconcile_item(text, text, text, text, numeric, text) TO authenticated, service_role;
...
REVOKE EXECUTE ON FUNCTION public.r1_reconcile_order(text, text) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_reconcile_order(text, text) TO authenticated, service_role;
...
REVOKE EXECUTE ON FUNCTION public.r1_save_order(text, text, bigint, integer, text, text, integer, text, numeric, numeric, numeric, numeric, numeric, text, jsonb, text, text, jsonb, timestamp with time zone) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_save_order(text, text, bigint, integer, text, text, integer, text, numeric, numeric, numeric, numeric, numeric, text, jsonb, text, text, jsonb, timestamp with time zone) TO authenticated, service_role;
...
REVOKE EXECUTE ON FUNCTION public.r1_save_order_idempotent(text, text, text, bigint, integer, text, text, integer, text, numeric, numeric, numeric, numeric, numeric, text, jsonb, text, text, jsonb, timestamp with time zone) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.r1_save_order_idempotent(text, text, text, bigint, integer, text, text, integer, text, numeric, numeric, numeric, numeric, numeric, text, jsonb, text, text, jsonb, timestamp with time zone) TO authenticated, service_role;
