...
--   [1] Dropped amalay_reservaciones section
--   [2] All other policies kept as-is (USING(true) — tighten in SKEL-04 for demo tables)
-- =============================================================================
...
-- OMITTED: amalay_reservaciones policies (table does not exist in sandbox)
