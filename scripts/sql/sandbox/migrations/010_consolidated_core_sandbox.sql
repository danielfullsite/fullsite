...
-- Source:  010_consolidated_core.sql
-- Branch:  sandbox/second-customer-skeleton
-- Project: fullsite-sandbox (NEVER apply to qjiomlvudfmzuvqvhwpk)
--
-- Transformations applied:
--   [1] Dropped all amalay_reservaciones lines (table, indexes, constraints)
--   [2] client_id columns: removed DEFAULT 'amalay', enforced NOT NULL
--   [3] Non-tenant columns (restaurante, location_id): removed DEFAULT 'amalay'/'amalay-spgg', kept nullable
-- =============================================================================
