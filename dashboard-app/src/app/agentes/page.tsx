...
const AGENTS = [
  ...
  { id: 'wansoft-staleness', name: 'Monitor Sync', icon: Activity, color: 'text-red-500', bg: 'bg-red-500/8', desc: 'Alerta si datos >24h sin sync', href: '/agentes/sync' },
  { id: 'proactive-alerts', name: 'Alertas Proactivas', icon: Bell, color: 'text-red-400', bg: 'bg-red-500/8', desc: 'Clima, eventos, dias festivos', href: '/agentes/alertas' },
