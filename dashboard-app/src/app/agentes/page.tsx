  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
          <p className="text-xs text-slate-500 font-medium mb-1">Advertencias</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {AGENTS.map(agent => {
          ...
          const card = (<>
              ...
              {hasData ? (
                <>
                  <p className="text-sm text-slate-700 leading-relaxed mb-3">{result.summary || 'Sin resumen'}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] text-slate-400">{timeSince}</span>
                    <span className="text-[11px] text-slate-400">{result.fecha}</span>
                  </div>
                </>
              ) : (
                <div className="py-2">
