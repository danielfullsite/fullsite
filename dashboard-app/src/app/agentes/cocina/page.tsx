    ...
    <>
      <div className="mb-6 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h2 className="text-xl font-bold text-[var(--text-1)]">Calidad de Cocina</h2>
      ...
      {!data ? (
        <div className="bg-[var(--surface)] rounded-xl border border-[var(--line)] shadow-sm p-8 text-center">
          <div className="w-12 h-12 rounded-xl bg-amber-500/10 flex items-center justify-center mx-auto mb-4"><ChefHat size={24} className="text-amber-500" /></div>
          <h3 className="text-base font-bold text-[var(--text-1)] mb-2">Sin datos de cocina</h3>
          <p className="text-sm text-[var(--text-3)] max-w-md mx-auto">El agente de calidad de cocina se actualiza automáticamente. Los datos aparecerán aquí cuando estén disponibles.</p>
        </div>
      ) : (
