    ...
    return (
      <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-[var(--text-1)]">Acceso restringido</h2>
          <p className="text-[var(--text-3)] mt-1">Solo el administrador puede ver las credenciales</p>
        </div>
      </div>
    )
  }
