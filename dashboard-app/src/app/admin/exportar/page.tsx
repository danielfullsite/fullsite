...
const EXPORTS = [
  ...
  { id: 'wansoft_recipes', label: 'Recetas históricas', icon: ChefHat, table: 'wansoft_recipes', select: 'saucer_id,saucer_name,budget_cost', filter: false, desc: 'Recetas históricas importadas' },
]
