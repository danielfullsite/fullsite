        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col items-center gap-4">
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/company/117814130" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-emerald-500 transition-colors">
