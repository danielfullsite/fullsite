...
export default function NominaPage() {
  ...
  const employees = useMemo((): Employee[] => {
    ...
    return Array.from(allNames).map(nombre => {
      ...
      // contra ese número.
      const horasMedidas = !!hours?.totalHours
      const hoursTotal = hours?.totalHours || (daysWorked * 8)
        ...
        {tab === 'prenomina' && (
          employees.length === 0 ? (
            <EmptyState
              ...
              description="Los datos se generan automaticamente desde las ventas del punto de venta. Verifica que haya datos en el periodo seleccionado."
            ...
            <div>
              ...
              <div className="px-4 py-3 border-t border-[var(--line-soft)] bg-amber-500/5">
                <p className="text-[11px] text-amber-500/80 flex items-center gap-1.5">
                  ...
                  Pre-nomina estimada. Las horas provienen del punto de venta. Deducciones estimadas al 5.5% (ISR ~3% + IMSS ~2.5%). Ajusta tarifa por hora manualmente.
                </p>
              </div>
            </div>
          )
        ...
        {tab === 'propinas' && (
          tips.length === 0 && totalTipsDaily === 0 ? (
            <EmptyState
              ...
              description="Las propinas se actualizan diario desde el punto de venta. Verifica que haya datos en el periodo seleccionado."
        ...
        {tab === 'asistencia' && (
          laborEntries.length === 0 && hoursWorked.length === 0 ? (
            <EmptyState
              ...
              description="La asistencia se actualiza diario desde el punto de venta. Verifica que haya datos de labor/hours_worked."
