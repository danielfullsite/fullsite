        ...
        {tab === 'prenomina' && (
          employees.length === 0 ? (
            <EmptyState
              ...
              description="Los datos se generan automaticamente desde las ventas históricas. Verifica que haya datos en el periodo seleccionado."
            ...
            <div>
              ...
              <div className="px-4 py-3 border-t border-[var(--line-soft)] bg-amber-500/5">
                <p className="text-[11px] text-amber-500/80 flex items-center gap-1.5">
                  ...
                  Pre-nomina estimada. Las horas provienen de la fuente histórica. Deducciones estimadas al 5.5% (ISR ~3% + IMSS ~2.5%). Ajusta tarifa por hora manualmente.
                </p>
              </div>
            </div>
          )
        ...
        {tab === 'propinas' && (
          tips.length === 0 && totalTipsDaily === 0 ? (
            <EmptyState
              ...
              description="Las propinas se actualizan diario desde la sincronización histórica. Verifica que haya datos en el periodo seleccionado."
        ...
        {tab === 'asistencia' && (
          laborEntries.length === 0 && hoursWorked.length === 0 ? (
            <EmptyState
              ...
              description="La asistencia se actualiza diario desde la sincronización histórica. Verifica que haya datos de asistencia."
