    ...
    <>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="No hay registros de ventas para el periodo. Los datos de propinas aparecerán cuando la sincronización histórica esté disponible."
              ...
              <p className="text-xs mb-5">
                {isRealTipsData ? (
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-700 font-medium">
                    ...
                    Datos reales de Fullsite · {realTipsDays} día{realTipsDays === 1 ? '' : 's'}
                  </span>
                ) : (
