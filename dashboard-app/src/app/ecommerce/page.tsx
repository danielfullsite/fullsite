        ...
        <>
          ...
          {ecommerceData.totalEcommerce === 0 ? (
            <div className="bg-[var(--surface)] rounded-xl border border-[var(--line)] shadow-sm p-8 text-center mb-6">
              ...
              <p className="text-sm text-[var(--text-3)] max-w-md mx-auto">No se encontraron ventas de Rappi, Ubereats u otras plataformas. Verifica que los pagos se registren correctamente en el POS.</p>
            </div>
          ) : (
            <>
              {/* Channel breakdown */}
