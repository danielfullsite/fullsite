...
// Catálogo plano de presentaciones históricas (Inventory/Presentations)
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        // Catálogo de productos históricos: Text = "NOMBRE (CODIGO)"
        ...
        // Catálogo plano de presentaciones históricas: {id, cell: [clave, presentacion, ...]}
        if (presCatRes.ok) {
