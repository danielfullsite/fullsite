...
const AGENTS = [
  ...
  { name: 'Monitor de sincronización', desc: 'Alerta si la sincronización de ventas tiene mas de 24h', status: 'activo', schedule: 'Diario 8am MX', tentacle: 'ops' },
  { name: 'Consulta de ventas (KB)', desc: 'Responde preguntas ad-hoc sobre ventas, meseros, platillos 24/7', status: 'activo', schedule: 'On-demand (Telegram)', tentacle: 'kb' },
  ...
  { name: 'Importador de ventas', desc: 'Importador automatico de reportes de ventas via Playwright', status: 'activo', schedule: '3pm avance, 8:30pm/11pm cierre', tentacle: 'ops' },
