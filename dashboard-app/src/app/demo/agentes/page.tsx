...
const AGENTS = [
  ...
  { name: 'Sincronización histórica', desc: 'Alerta si la sincronizacion de datos tiene mas de 24h', status: 'activo', schedule: 'Diario 8am MX', tentacle: 'ops' },
  { name: 'Fullsite Query (KB)', desc: 'Responde preguntas ad-hoc sobre ventas, meseros, platillos 24/7', status: 'activo', schedule: 'On-demand (Telegram)', tentacle: 'kb' },
  ...
  { name: 'Scraper de reportes', desc: 'Scraper automatico de reportes POS via Playwright', status: 'activo', schedule: '3pm avance, 8:30pm/11pm cierre', tentacle: 'ops' },
