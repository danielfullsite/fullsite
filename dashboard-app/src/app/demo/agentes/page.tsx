...
const AGENTS = [
  ...
  { name: 'Data Freshness', desc: 'Alerta si la sincronización de datos tiene más de 24h', status: 'activo', schedule: 'Diario 8am MX', tentacle: 'ops' },
  ...
  { name: 'Data Sync', desc: 'Sincronización automática de reportes operativos', status: 'activo', schedule: '3pm avance, 8:30pm/11pm cierre', tentacle: 'ops' },
