                ...
                return (
                  <tr key={p.nombre} className="border-b border-white/5 last:border-0">
                    <td className="py-3 pr-4">
                      <span className={`font-bold ${i < 3 ? 'text-orange-400' : 'text-zinc-500'}`}>{i + 1}</span>
                    </td>
                    <td className="py-3 pr-4 font-medium">{p.nombre}</td>
                    <td className="py-3 pr-4 text-right text-zinc-400">{p.cantidad}</td>
                    <td className="py-3 pr-4 text-right font-bold text-emerald-400">{formatDemoMXN(p.total)}</td>
                    <td className="py-3 pr-4 text-right text-zinc-400">{formatDemoMXN(precioUnit)}</td>
                    <td className="py-3 text-right text-zinc-500">{pctTotal}%</td>
                  </tr>
                )
              })}
            </tbody>
