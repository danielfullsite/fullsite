      ...
      <header className="border-b border-white/5 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-500">{DEMO_RESTAURANT.name} · Trimestre Mar-May 2026</p>
          </div>
        </div>
      </header>
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-2xl overflow-hidden">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {MESES.map((m, i) => (
                  <tr key={m.mes} className="border-b border-white/5 last:border-0 hover:bg-white/[0.02]">
                    ...
                    <td className="px-5 py-3 text-right text-zinc-400">{formatDemoMXN(m.propinas)}</td>
            ...
            {MESES.map((m) => {
              ...
              return (
                <div key={m.mes} className="flex items-center gap-4">
                  <span className="text-sm text-zinc-400 w-28 shrink-0">{m.mes}</span>
