    ...
    <div className="min-h-screen bg-[#0a0a0c] text-white p-6 md:p-10">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500">Personaliza platillos &middot; Casa Montana</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-xs text-zinc-600 ml-auto">{QUITAR.length} opciones</span>
          </div>
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="text-xs text-zinc-600 ml-auto">{AGREGAR.length} opciones</span>
          </div>
          <div className="flex flex-wrap gap-2">
            {AGREGAR.map(a => (
              <span
