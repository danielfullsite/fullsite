                ...
                return (
                  <tr key={m.nombre} className="border-b border-white/5 last:border-0">
                    <td className="py-3 pr-4">
                      <span className={`font-bold ${i < 3 ? 'text-amber-400' : 'text-zinc-500'}`}>{i + 1}</span>
                    </td>
                    ...
                    <td className="py-3 pr-4 text-right text-zinc-400">{formatDemoMXN(tp)}</td>
                    <td className="py-3 pr-4 text-right text-emerald-400/70">{formatDemoMXN(m.propinas)}</td>
                    <td className="py-3 text-right text-zinc-400">{m.personas}</td>
                  </tr>
                )
              })}
            </tbody>
