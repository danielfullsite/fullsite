                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      ...
                      <div className="flex items-center gap-3">
                        <span className="text-xs text-[var(--text-3)]">{pctPropina}%</span>
              ...
              {sorted.map(m => {
                ...
                return (
                  <tr key={m.nombre} className="border-b border-[var(--line)] last:border-0">
                    ...
                    <td className={`py-3 pr-4 text-right font-semibold ${isHigh ? 'text-emerald-400' : 'text-[var(--text-2)]'}`}>{pctP}%</td>
                    <td className="py-3 pr-4 text-right text-[var(--text-2)]">{formatDemoMXN(m.total)}</td>
                    <td className="py-3 pr-4 text-right text-[var(--text-2)]">{m.tickets}</td>
                    <td className="py-3 text-right text-[var(--text-2)]">{formatDemoMXN(propTicket)}</td>
                  </tr>
                )
              })}
            </tbody>
