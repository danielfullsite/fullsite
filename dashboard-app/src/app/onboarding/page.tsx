              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select value={posSystem} onChange={e => setPosSystem(e.target.value)}
                    ...
                    <option value="wansoft">Sistema POS anterior</option>
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input value={posUser} onChange={e => setPosUser(e.target.value)}
                          placeholder="usuario del POS" className="w-full border border-[var(--line)] rounded-xl px-4 py-3 text-sm mt-1 focus:outline-none focus:border-emerald-500" />
                      </div>
                      <div>
                    ...
                    {posSystem === 'wansoft' && (
                      <div>
                        ...
                        <p className="text-xs text-[var(--text-3)] mt-1">Lo encuentras en la configuración de tu POS actual → Sucursal</p>
                      </div>
                    )}
