...
const PLATILLOS = [
  { nombre: 'Arrachera 500g', qty: 285, revenue: 285 * 595 },
  { nombre: 'Carne Asada 500g', qty: 248, revenue: 248 * 450 },
  { nombre: 'Quesabirrias', qty: 231, revenue: 231 * 269 },
  { nombre: 'Mix Asada/Pechuga', qty: 198, revenue: 198 * 299 },
  { nombre: 'Rib Eye Cowboy 600g', qty: 145, revenue: 145 * 790 },
  { nombre: 'Agujas Norteñas 700g', qty: 134, revenue: 134 * 659 },
  { nombre: 'Botana Surtida', qty: 128, revenue: 128 * 359 },
  { nombre: 'Gaoneras', qty: 115, revenue: 115 * 295 },
  { nombre: 'Picaña 600g', qty: 104, revenue: 104 * 690 },
  { nombre: 'New York 700g', qty: 97, revenue: 97 * 750 },
]
...
const AGENTS = [
  ...
  },
  {
    ...
    name: 'FOOD COST',
    message: 'Arrachera subio 18% esta semana ($289 -> $341/kg). Margen en Arrachera 500g bajo de 62% a 51%. Considerar ajuste de precio o promover Diezmillo.',
    time: 'Hace 1 hr',
  },
  {
    emoji: '\uD83D\uDFE2',
  ...
  },
  {
    ...
    name: 'UPSELLING',
    message: 'Mesero Carlos Mendoza (Patio Lincoln) no ha vendido Especialidades NG en 3 dias. Promedio del equipo: 4 por turno. Oportunidad: Rib Eye Cowboy y Picaña.',
    time: 'Hace 45 min',
  },
  {
    emoji: '\uD83D\uDFE0',
  ...
  },
  {
    ...
    message: 'Quesabirrias ($269): estrella emergente. Ventas +45% en 2 semanas. Margacheve ($169) es el drink mas rentable. Promover combo Quesabirrias + Margacheve.',
    time: 'Hace 3 hrs',
  },
]

const POS_CATEGORIES = [
  { name: 'Parrilladas', color: '#ef4444' },
  { name: 'Especialidades', color: '#f59e0b' },
  { name: 'Botanas', color: '#a855f7' },
  { name: 'Guarniciones', color: '#10b981' },
  { name: 'Bebidas', color: '#3b82f6' },
  { name: 'Postres', color: '#ec4899' },
  { name: 'Cervezas', color: '#f97316' },
  { name: 'Drinks', color: '#8b5cf6' },
]

const POS_ITEMS = [
  // Parrilladas
  { name: 'Arrachera 500g', price: 595, cat: 'Parrilladas' },
  { name: 'Carne Asada 500g', price: 450, cat: 'Parrilladas' },
  { name: 'Diezmillo 500g', price: 495, cat: 'Parrilladas' },
  { name: 'Agujas Norteñas 700g', price: 659, cat: 'Parrilladas' },
  { name: 'Pechuga Adobada 500g', price: 350, cat: 'Parrilladas' },
  { name: 'Mix Asada/Pechuga', price: 299, cat: 'Parrilladas' },
  { name: 'Arrachera y Pechuga', price: 395, cat: 'Parrilladas' },
  // Especialidades
  { name: 'Rib Eye Cowboy 600g', price: 790, cat: 'Especialidades' },
  { name: 'New York 700g', price: 750, cat: 'Especialidades' },
  { name: 'Picaña 600g', price: 690, cat: 'Especialidades' },
  { name: 'Costillar Adobado 1kg', price: 650, cat: 'Especialidades' },
  // Botanas
  { name: 'Botana Surtida', price: 359, cat: 'Botanas' },
  { name: 'Quesabirrias', price: 269, cat: 'Botanas' },
  { name: 'Gaoneras', price: 295, cat: 'Botanas' },
  { name: 'Gorditas Rellenas', price: 199, cat: 'Botanas' },
  { name: 'Guacamole c/ Chicharron', price: 199, cat: 'Botanas' },
  { name: 'Quesopapa', price: 199, cat: 'Botanas' },
  { name: 'Coliflor Frita', price: 195, cat: 'Botanas' },
  { name: 'Pasta Norestense', price: 189, cat: 'Botanas' },
  { name: 'Empalmes', price: 195, cat: 'Botanas' },
  { name: 'Queso Fundido Chistorra', price: 199, cat: 'Botanas' },
  { name: 'Ensalada Fit', price: 189, cat: 'Botanas' },
  { name: 'Consomé de Res', price: 69, cat: 'Botanas' },
  // Guarniciones
  { name: 'Frijoles a la Charra', price: 45, cat: 'Guarniciones' },
  { name: 'Papas Galeana NG', price: 59, cat: 'Guarniciones' },
  { name: 'Papa Francesa 250g', price: 69, cat: 'Guarniciones' },
  { name: 'Frijoles Refritos c/ Asado', price: 95, cat: 'Guarniciones' },
  { name: 'Canoa de Tuétano', price: 89, cat: 'Guarniciones' },
  { name: 'Salchicha Asada', price: 59, cat: 'Guarniciones' },
  { name: 'Nopales Asados', price: 49, cat: 'Guarniciones' },
  { name: 'Molcajete Ardiendo', price: 150, cat: 'Guarniciones' },
  // Bebidas
  { name: 'Refresco Lata', price: 45, cat: 'Bebidas' },
  { name: 'Refill', price: 69, cat: 'Bebidas' },
  { name: 'Agua Natural 500ml', price: 29, cat: 'Bebidas' },
  { name: 'Jarra de Agua 1L', price: 99, cat: 'Bebidas' },
  { name: 'Jarra de Agua 2L', price: 189, cat: 'Bebidas' },
  // Postres
  { name: 'Cheesecake', price: 169, cat: 'Postres' },
  { name: 'Brownie', price: 159, cat: 'Postres' },
  { name: 'Tarta de Plátano', price: 145, cat: 'Postres' },
  { name: 'Pan de Elote', price: 99, cat: 'Postres' },
  { name: 'Flan de la Casa', price: 95, cat: 'Postres' },
  { name: 'Affogato', price: 69, cat: 'Postres' },
  // Cervezas
  { name: 'Cerveza Artesanal NG', price: 69, cat: 'Cervezas' },
  { name: 'Cubeta Artesanal 4pack', price: 250, cat: 'Cervezas' },
  { name: 'Heineken/Tecate/Indio', price: 49, cat: 'Cervezas' },
  { name: 'Bohemia/Amstel/Heineken Silver', price: 59, cat: 'Cervezas' },
  // Drinks
  { name: 'Margacheve', price: 169, cat: 'Drinks' },
  { name: 'Cantarito NG 1L', price: 169, cat: 'Drinks' },
  { name: 'Mojito Maracuyá', price: 159, cat: 'Drinks' },
  { name: 'Tamarindo Tropical', price: 150, cat: 'Drinks' },
  { name: 'Piña Colada', price: 149, cat: 'Drinks' },
  { name: 'Clericot Copa', price: 129, cat: 'Drinks' },
  { name: 'Clamato NG', price: 99, cat: 'Drinks' },
]
