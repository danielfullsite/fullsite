...
export interface PagoDeCaja { payment_id: string; account_id: string; amount_cents: number; method: 'cash' | 'external'; status: 'pending' | 'unknown' | 'accepted' | 'rejected'; change_cents?: number }
