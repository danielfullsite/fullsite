...
/**
 * Rol efectivo para acciones administrativas. Un rol insuficiente bloquea antes
 * del primer efecto. El tercer argumento se conserva por compatibilidad; una
 * variable de entorno no convierte el rechazo en permiso.
 */
