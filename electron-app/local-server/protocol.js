...
const EVENT = {
  ...
  ORDER_ITEMS_TRANSFERRED: 'ORDER_ITEMS_TRANSFERRED',
  ...
  ORDER_PRECHECK_PRINT: 'ORDER_PRECHECK_PRINT',
  PAYMENT_RECEIPT_PRINT: 'PAYMENT_RECEIPT_PRINT',
  PRINT_UNCERTAIN_RESOLVE: 'PRINT_UNCERTAIN_RESOLVE',
  PAYMENT_DRAWER_OPEN: 'PAYMENT_DRAWER_OPEN',
  DRAWER_OPEN: 'DRAWER_OPEN',
  DRAWER_UNCERTAIN_RESOLVE: 'DRAWER_UNCERTAIN_RESOLVE',
